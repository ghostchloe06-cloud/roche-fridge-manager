(function() {
  ...
  function installStyle() {
    ...
    style.textContent = [
      ...
      "." + ROOT_CLASS + " .fm-day-label{padding:6px 0 0 20px;color:#1c1c1e;font-size:16px;font-weight:700}",
      ...
      "." + ROOT_CLASS + " .fm-meal-row textarea{flex:1;min-width:0;border:0;background:#f2f2f7;border-radius:16px;margin-bottom:0;font-size:15px;font-weight:600;color:#1c1c1e;min-height:54px;line-height:1.35;padding:17px 18px}",
