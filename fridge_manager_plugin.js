(function() {
    ...
    return [
      '<form class="fm-form" data-form="item">',
        ...
        '<div class="fm-form-row">',
          ...
          '<input name="unit" value="' + escapeHtml(item.unit || "") + '" placeholder="单位，例如：个">',
        '</div>',
        '<div class="fm-form-row">',
        ...
        '<div class="fm-form-row">',
          ...
          '<input name="lowStockAt" type="number" min="0" step="0.1" value="' + escapeHtml(item.lowStockAt || "") + '" placeholder="低库存提醒数量">',
        '</div>',
  ...
  function renderMealSlot(slot) {
    ...
    return [
      '<article class="fm-meal">',
        ...
        '</div>',
        '<textarea data-menu-title="' + slot.id + '" rows="2" placeholder="' + slot.mealLabel + '餐，留空可生成">' + escapeHtml(slot.title || "") + '</textarea>',
  ...
  function installStyle() {
    ...
    style.textContent = [
      ...
      "." + ROOT_CLASS + " .fm-nav-btn,." + ROOT_CLASS + " .fm-icon-btn{width:56px;height:56px;border-radius:999px;border:1px solid #ececee;background:#f7f7f8;display:grid;place-items:center;color:#1c1c1e}",
      ...
      "." + ROOT_CLASS + " input,." + ROOT_CLASS + " textarea,." + ROOT_CLASS + " select{width:100%;border:1px solid #d8d8dc;background:#ffffff;border-radius:14px;padding:16px 18px;color:#1c1c1e;outline:none;font-size:16px}",
      "." + ROOT_CLASS + " input::placeholder,." + ROOT_CLASS + " textarea::placeholder{color:#9a9a9e}",
      "." + ROOT_CLASS + " textarea{resize:vertical;min-height:58px;line-height:1.5}",
      ...
      "." + ROOT_CLASS + " .fm-primary,." + ROOT_CLASS + " .fm-secondary,." + ROOT_CLASS + " .fm-ghost-btn{min-height:48px;border-radius:14px;padding:0 18px;border:1px solid #d8d8dc;display:inline-flex;align-items:center;justify-content:center;gap:8px;white-space:nowrap;font-weight:600}",
      ...
      "." + ROOT_CLASS + " .fm-chips button{flex:0 0 auto;min-height:46px;border:1px solid #d8d8dc;background:#ffffff;border-radius:14px;padding:0 18px;color:#9a9a9e;font-weight:600}",
      ...
      "." + ROOT_CLASS + " .fm-meal textarea{border:0;background:#f2f2f7;border-radius:14px;margin-bottom:10px;font-size:16px;font-weight:600}",
      ...
      "." + ROOT_CLASS + " .fm-header{height:78px;grid-template-columns:56px 1fr 156px;padding:10px 14px}",
      "." + ROOT_CLASS + " .fm-nav-btn,." + ROOT_CLASS + " .fm-icon-btn{width:48px;height:48px}",
      ...
      "." + ROOT_CLASS + " .fm-form-row{grid-template-columns:1fr}",
