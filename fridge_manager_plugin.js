(function() {
  ...
  function renderItemForm() {
    ...
    return [
      '<form class="fm-form" data-form="item">',
        '<div class="fm-add-card">',
          '<div class="fm-add-top">',
            '<input name="name" value="' + escapeHtml(item.name || "") + '" placeholder="添加新食材，例如：鸡蛋..." required>',
            '<button class="fm-add-button" type="submit" title="' + (state.editingItemId ? "保存" : "添加") + '">' + ICONS.plus + '</button>',
          '</div>',
          '<div class="fm-add-meta">',
          ...
          '<input name="category" value="' + escapeHtml(item.category || "") + '" placeholder="分类">',
          '</div>',
          '<div class="fm-add-meta fm-add-meta-optional">',
        ...
        '</div>',
        state.editingItemId ? '<div class="fm-actions"><button class="fm-secondary" type="button" data-action="cancel-edit">取消</button></div>' : "",
      '</form>'
    ].join("");
  }
  ...
  function installStyle() {
    ...
    style.textContent = [
      ...
      "." + ROOT_CLASS + " .fm-panel{min-width:0;overflow:hidden;border:0;border-bottom:1px solid #ececee;background:#ffffff;border-radius:0;padding:22px 26px;box-shadow:none}",
      ...
      "." + ROOT_CLASS + " .fm-add-card{display:grid;gap:10px;border:1px solid #ececee;background:#fff;border-radius:24px;padding:14px;box-shadow:0 10px 30px rgba(28,28,30,.04)}",
      "." + ROOT_CLASS + " .fm-add-top{display:grid;grid-template-columns:minmax(0,1fr) 56px;gap:10px;align-items:center}",
      "." + ROOT_CLASS + " .fm-add-button{width:56px;height:56px;border-radius:18px;border:0;background:#1c1c1e;color:#fff;display:grid;place-items:center}",
      "." + ROOT_CLASS + " .fm-add-button svg{width:20px;height:20px}",
      "." + ROOT_CLASS + " .fm-add-meta{display:grid;grid-template-columns:minmax(0,.8fr) minmax(0,1fr) minmax(0,2.2fr);gap:10px}",
      "." + ROOT_CLASS + " .fm-add-meta-optional{grid-template-columns:minmax(0,1fr) minmax(0,1.4fr) minmax(0,1.6fr)}",
      "." + ROOT_CLASS + " .fm-add-card input,." + ROOT_CLASS + " .fm-add-card textarea,." + ROOT_CLASS + " .fm-add-card select{border:0;background:#f2f2f7;border-radius:16px}",
      "." + ROOT_CLASS + " .fm-add-card textarea{min-height:48px}",
      "." + ROOT_CLASS + " .fm-form-row{display:grid;grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:12px}",
      "." + ROOT_CLASS + " .fm-form-row.fm-form-quad{grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}",
      "." + ROOT_CLASS + " .fm-form-row.fm-form-quad input,." + ROOT_CLASS + " .fm-form-row.fm-form-quad select{padding-left:8px;padding-right:8px;text-align:center}",
      "." + ROOT_CLASS + " input,." + ROOT_CLASS + " textarea,." + ROOT_CLASS + " select{width:100%;min-width:0;border:1px solid #d8d8dc;background:#ffffff;border-radius:14px;padding:11px 14px;color:#1c1c1e;outline:none;font-size:14px}",
      ...
      "." + ROOT_CLASS + " input[type=checkbox]:checked,." + ROOT_CLASS + " input[type=radio]:checked{background:#1c1c1e;border-color:#1c1c1e}",
      "." + ROOT_CLASS + " input[type=checkbox]:checked::after{content:'';position:absolute;left:5px;top:1px;width:4px;height:9px;border:solid #ffffff;border-width:0 2px 2px 0;transform:rotate(45deg)}",
      "." + ROOT_CLASS + " input[type=radio]:checked::after{content:'';position:absolute;left:4px;top:4px;width:8px;height:8px;border-radius:50%;background:#ffffff}",
      ...
      "." + ROOT_CLASS + " .fm-add-card input,." + ROOT_CLASS + " .fm-add-card textarea,." + ROOT_CLASS + " .fm-add-card select{border:0;background:#f2f2f7;border-radius:16px}",
      "." + ROOT_CLASS + " .fm-add-top input{height:56px;font-size:18px}",
      "." + ROOT_CLASS + " .fm-add-meta input,." + ROOT_CLASS + " .fm-add-meta select{height:48px}",
      ...
      "." + ROOT_CLASS + " .fm-item-actions{display:flex;flex-wrap:wrap;gap:14px;justify-content:flex-start;align-items:center}",
      ...
      "." + ROOT_CLASS + " .fm-menu-list{display:grid;gap:16px;margin:0}",
      "." + ROOT_CLASS + " .fm-day-row{display:grid;grid-template-columns:72px 1fr;gap:0;align-items:stretch;border:1px solid #ececee;border-radius:24px;background:#fff;overflow:hidden;padding:14px 0}",
      "." + ROOT_CLASS + " .fm-day-label{padding:6px 0 0 20px;color:#6e6e73;font-size:16px;font-weight:600}",
      "." + ROOT_CLASS + " .fm-meal-cells{display:grid;grid-template-columns:1fr;gap:10px;padding:0 18px 0 0}",
      "." + ROOT_CLASS + " .fm-meal{background:transparent;border:0;border-radius:0;padding:0;min-width:0}",
      "." + ROOT_CLASS + " .fm-meal-row{display:flex;align-items:center;gap:8px;margin-bottom:10px}",
      "." + ROOT_CLASS + " .fm-meal-label{flex:0 0 auto;width:54px;height:54px;border-radius:999px;background:#f2f2f7;border:1px solid #ececee;display:grid;place-items:center;color:#1c1c1e;font-size:18px;font-weight:700;letter-spacing:0}",
      ...
      "." + ROOT_CLASS + " .fm-meal-row textarea{flex:1;min-width:0;border:0;background:#f2f2f7;border-radius:16px;margin-bottom:0;font-size:20px;font-weight:500;min-height:54px;line-height:1.35;padding:13px 18px}",
      ...
      "." + ROOT_CLASS + " .fm-form-row.fm-form-quad{grid-template-columns:repeat(4,minmax(0,1fr));gap:8px}",
      "." + ROOT_CLASS + " .fm-form-row.fm-form-quad input,." + ROOT_CLASS + " .fm-form-row.fm-form-quad select{padding-left:6px;padding-right:6px;font-size:12px}",
      "." + ROOT_CLASS + " .fm-chips{margin-left:-18px;margin-right:-18px;padding-left:18px;padding-right:18px}",
      "." + ROOT_CLASS + " .fm-menu-list{margin-left:0;margin-right:0}",
      ...
      "." + ROOT_CLASS + " .fm-add-card{padding:12px;border-radius:20px}",
      "." + ROOT_CLASS + " .fm-add-top{grid-template-columns:minmax(0,1fr) 52px}",
      "." + ROOT_CLASS + " .fm-add-button{width:52px;height:52px;border-radius:16px}",
      "." + ROOT_CLASS + " .fm-add-meta{grid-template-columns:minmax(0,.8fr) minmax(0,1fr) minmax(0,2fr);gap:8px}",
      "." + ROOT_CLASS + " .fm-add-meta-optional{grid-template-columns:minmax(0,1fr) minmax(0,1.2fr) minmax(0,1.4fr)}",
      "." + ROOT_CLASS + " .fm-shop-row{grid-template-columns:auto 1fr auto}",
      "." + ROOT_CLASS + " .fm-shop-row em{grid-column:2 / -1}",
      "}",
      "@media (max-width: 430px){",
      "." + ROOT_CLASS + " .fm-add-meta,." + ROOT_CLASS + " .fm-add-meta-optional{grid-template-columns:1fr}",
      "." + ROOT_CLASS + " .fm-form-row.fm-form-quad{grid-template-columns:repeat(2,minmax(0,1fr))}",
      "}"
    ].join("\n");
